...
int main( )
{
    ...
    //identificar
    IO_id("Exemplo 0217 - Programa - v.0.0");
    ...
    {
        IO_printf("numero e par e negativo: %d\n", number);
    }
    else
    {
        IO_printf("numero nao e par e negativo: %d\n", number);
    }

    if (((number2%2)!=0) && number>0)
    {
        IO_printf("numero e impar e positivo: %d\n", number2);
    }
    else
    {
        IO_printf("numero nao e impar e positivo: %d\n", number2);
    }
