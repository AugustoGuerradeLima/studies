...
void method01()
{
    ...
    //identificar
    IO_id("Exemplo0309 - method01 - v.0.0");
...
void method02()
{
    ...
    //identificar
    IO_id("Exemplo0309 - method02 - v.0.0");
...
void method03()
{
    ...
    //identificar
    IO_id("Exemplo0309 - method03 - v.0.0");
...
int main()
{
    ...
    {
        //identificar
        IO_id("Exemplo0309 - Programa - v.0.0");
