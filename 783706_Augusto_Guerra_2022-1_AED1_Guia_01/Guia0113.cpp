 ...
 */
 void doTask( )
 {
    ...
    doPartialTask();
    moveN(2);
//robo pega um marcador em x=3 y=3
if ( nextToABeeper( ) )
 {
...
//robo se movimenta para x=6 y=3
    turnRight();
    moveN(3);
//robo pega um marcador em x=6 y=3
if ( nextToABeeper( ) )
 {
 // ... de tentar carrega-lo
 pickBeeper( );
...
//robo se movimenta para x=6 y=6
    turnLeft();
    moveN(3);
//robo pega um marcador em x=6 y=6
if ( nextToABeeper( ) )
 {
 // ... de tentar carrega-lo
 pickBeeper( );
    ...
    moveN(5);
    turnRight( );
//descarrega o marcador na posição x=6 y=1
if ( nbeepers( ) > 0 )
 {
 ...
 putBeeper( );
    ...
    moveN(1);
//descarrega o marcador na posição x=5 y=1
if ( nbeepers( ) > 0 )
 {
 // ... de tentar descarrega-lo
 putBeeper( );
    ...
    moveN(1);
//descarrega o marcador na posição x=4 y=1
if ( nbeepers( ) > 0 )
 {
 // ... de tentar descarrega-lo
 putBeeper( );
