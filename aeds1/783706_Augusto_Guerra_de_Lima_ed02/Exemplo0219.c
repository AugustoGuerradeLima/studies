...
int main( )
{
    ...
    //identificar
    IO_id("Exemplo 0219 - Programa - v.0.0");
    ...
    if(numero2==numero3)
    {
        IO_printf("o segundo e o terceiro numero sao iguais portanto o primeiro nao pode estar entre eles...\n");
    ...
    {
        IO_printf("O primeiro valor nao esta entre os outros dois valores inseridos\n"); //caso numero1 nao esteja entre os outros dois numeros (numero2 e numero3 ou numero3 e numero2)
    }
    }
