...
void method01()
{
    ...
    //identificar
    IO_id("Exemplo0307 - method01 - v.0.0");
...
void method02()
{
    ...
    //identificar
    IO_id("Exemplo0307 - method02 - v.0.0");
...
void method03()
{
    ...
    //identificar
    IO_id("Exemplo0307 - method03 - v.0.0");
...
int main()
{
    ...
    {
        //identificar
        IO_id("Exemplo0307 - Programa - v.0.0");
        ...
        switch(x)
        {
            ...
            default:
            printf("Valor diferente das opcoes[0,1,2,3,4,5,6,7] %d\nEntrar com uma opcao:",x);
            getchar();
        }//fim escolher
